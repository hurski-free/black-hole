...
export const BLACK_HOLE_GRAVITY_COEFFICIENT = 3;
export const STAR_GRAVITY_COEFFICIENT = 0.1;
...
export const STAR_HOVER_RADIUS_INC = 0.1;

export const SUPERNOVA_RADIUS_INC = 0.8;
export const SUPERNOVA_RADIUS_DEC = 0.4;
